...
public:
    ...
    virtual void random_walk(const std::vector<Vibration>& vibrations);
};

class SpiderCVM : public Spider{
public:
    SpiderCVM(const Position& position);
    virtual void random_walk(const std::vector<Vibration>& vibrations);
};

class SpiderGCVM : public Spider{
public:
    Problem* problem;
    SpiderGCVM(const Position& position, Problem* problem);
    virtual void random_walk(const std::vector<Vibration>& vibrations);
};
